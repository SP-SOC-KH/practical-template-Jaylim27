...
module.exports.create = function create(code, name, credit) { const sql = 'CALL create_module($1, $2, $3)';
    ...
    module.exports.updateByCode = function updateByCode(code, credit) {
        ...
        .catch(function (error) {
            if (error.code === SQL_ERROR_CODE.NO_DATA_FOUND) {
                throw new EMPTY_RESULT_ERROR(`Module ${code} not found! Update failed.`);
            }
            throw error;
        });
    };
    ...
    module.exports.deleteByCode = function deleteByCode(code) { 
        ...
        return query(sql, [code])
            ...
            .catch(function (error) {
                if (error.code === SQL_ERROR_CODE.NO_DATA_FOUND) {
                    throw new EMPTY_RESULT_ERROR(`Module ${code} not found! Delete failed.`);
                }
                throw error;
            });
    };
